...
Patch0:     packaging/PATCH-01-83-Unify-error-message.patch
Patch1:     packaging/PATCH-02-83-mdadm-Fix-double-free.patch
Patch2:     packaging/PATCH-03-83-Grow_reshape-Add-r0-grow-size-error-message-a.patch
Patch3:     packaging/PATCH-04-83-udev-adapt-rules-to-systemd-v247.patch
Patch4:     packaging/PATCH-05-83-Replace-error-prone-signal-with-sigaction.patch
Patch5:     packaging/PATCH-06-83-mdadm-Respect-config-file-location-in-man.patch
Patch6:     packaging/PATCH-07-83-mdadm-Update-ReadMe.patch
Patch7:     packaging/PATCH-08-83-mdadm-Update-config-man-regarding-default-fil.patch
Patch8:     packaging/PATCH-09-83-mdadm-Update-config-manual.patch
Patch9:     packaging/PATCH-10-83-Create-Build-use-default_layout.patch
Patch10:    packaging/PATCH-11-83-mdadm-add-map_num_s.patch
Patch11:    packaging/PATCH-012-120-mdadm-systemd-remove-KillMode-none-from-ser.patch
Patch12:    packaging/PATCH-13-83-mdmon-Stop-parsing-duplicate-options.patch
Patch13:    packaging/PATCH-14-83-Grow-block-n-on-external-volumes.patch
Patch14:    packaging/PATCH-15-83-Incremental-Fix-possible-memory-and-resource-.patch
Patch15:    packaging/PATCH-16-83-Mdmonitor-Fix-segfault.patch
Patch16:    packaging/PATCH-17-83-Mdmonitor-Improve-logging-method.patch
Patch17:    packaging/PATCH-18-83-Fix-possible-NULL-ptr-dereferences-and-memory.patch
Patch18:    packaging/PATCH-19-83-imsm-Remove-possibility-for-get_imsm_dev-to-r.patch
Patch19:    packaging/PATCH-20-83-Revert-mdadm-fix-coredump-of-mdadm-monitor-r.patch
Patch20:    packaging/PATCH-21-83-util-replace-ioctl-use-with-function.patch
Patch21:    packaging/PATCH-22-83-mdadm-super1-restore-commit-45a87c2f31335-to-.patch
Patch22:    packaging/PATCH-23-83-imsm-introduce-get_disk_slot_in_dev.patch
Patch23:    packaging/PATCH-24-83-imsm-use-same-slot-across-container.patch
Patch24:    packaging/PATCH-25-83-imsm-block-changing-slots-during-creation.patch
Patch25:    packaging/PATCH-26-83-mdadm-block-update-ppl-for-non-raid456-levels.patch
Patch26:    packaging/PATCH-27-83-mdadm-Fix-array-size-mismatch-after-grow.patch
Patch27:    packaging/PATCH-28-83-mdadm-Remove-dead-code-in-imsm_fix_size_misma.patch
Patch28:    packaging/PATCH-29-83-Monitor-use-devname-as-char-array-instead-of-.patch
Patch29:    packaging/PATCH-30-83-Monitor-use-snprintf-to-fill-device-name.patch
Patch30:    packaging/PATCH-31-83-Makefile-Don-t-build-static-build-with-everyt.patch
Patch31:    packaging/PATCH-32-83-DDF-Cleanup-validate_geometry_ddf_container.patch
Patch32:    packaging/PATCH-33-83-DDF-Fix-NULL-pointer-dereference-in-validate_.patch
Patch33:    packaging/PATCH-34-83-mdadm-Grow-Fix-use-after-close-bug-by-closing.patch
Patch34:    packaging/PATCH-35-83-monitor-Avoid-segfault-when-calling-NULL-get_.patch
Patch35:    packaging/PATCH-36-83-mdadm-Fix-mdadm-r-remove-option-regression.patch
Patch36:    packaging/PATCH-37-83-mdadm-Fix-optional-write-behind-parameter.patch
Patch37:    packaging/PATCH-38-83-tests-00raid0-add-a-test-that-validates-raid0.patch
Patch38:    packaging/PATCH-39-83-tests-fix-raid0-tests-for-0.90-metadata.patch
Patch39:    packaging/PATCH-40-83-tests-04update-metadata-avoid-passing-chunk-s.patch
Patch40:    packaging/PATCH-41-83-tests-02lineargrow-clear-the-superblock-at-ev.patch
Patch41:    packaging/PATCH-42-83-mdadm-test-Add-a-mode-to-repeat-specified-tes.patch
Patch42:    packaging/PATCH-43-83-mdadm-test-Mark-and-ignore-broken-test-failur.patch
Patch43:    packaging/PATCH-44-83-tests-Add-broken-files-for-all-broken-tests.patch
Patch44:    packaging/PATCH-45-83-mdadm-Replace-obsolete-usleep-with-nanosleep.patch
Patch45:    packaging/PATCH-46-83-tests-00readonly-Run-udevadm-settle-before-se.patch
Patch46:    packaging/PATCH-47-83-tests-add-test-for-names.patch
Patch47:    packaging/PATCH-48-83-mdadm-remove-symlink-option.patch
Patch48:    packaging/PATCH-49-83-mdadm-move-data_offset-to-struct-shape.patch
Patch49:    packaging/PATCH-50-83-mdadm-Don-t-open-md-device-for-CREATE-and-ASS.patch
Patch50:    packaging/PATCH-51-83-Grow-Split-Grow_reshape-into-helper-function.patch
Patch51:    packaging/PATCH-52-83-Assemble-check-if-device-is-container-before-.patch
Patch52:    packaging/PATCH-53-83-super1-report-truncated-device.patch
Patch53:    packaging/PATCH-54-83-mdadm-Correct-typos-punctuation-and-grammar-i.patch
Patch54:    packaging/PATCH-55-83-Manage-Block-unsafe-member-failing.patch
Patch55:    packaging/PATCH-56-83-Monitor-Fix-statelist-memory-leaks.patch
Patch56:    packaging/PATCH-57-83-mdadm-added-support-for-Intel-Alderlake-RST-o.patch
Patch57:    packaging/PATCH-58-83-mdadm-Add-Documentation-entries-to-systemd-se.patch
Patch58:    packaging/PATCH-59-83-ReadMe-fix-command-line-help.patch
Patch59:    packaging/PATCH-60-83-mdadm-replace-container-level-checking-with-i.patch
Patch60:    packaging/PATCH-61-83-Mdmonitor-Omit-non-md-devices.patch
Patch61:    packaging/PATCH-62-83-Mdmonitor-Split-alert-into-separate-functions.patch
Patch62:    packaging/PATCH-63-83-Monitor-block-if-monitor-modes-are-combined.patch
Patch63:    packaging/PATCH-64-83-Update-mdadm-Monitor-manual.patch
Patch64:    packaging/PATCH-65-83-Grow-fix-possible-memory-leak.patch
Patch65:    packaging/PATCH-66-83-mdadm-create-ident_init.patch
Patch66:    packaging/PATCH-67-83-mdadm-Add-option-validation-for-update-subarr.patch
Patch67:    packaging/PATCH-68-83-Fix-update-subarray-on-active-volume.patch
Patch68:    packaging/PATCH-69-83-Add-code-specific-update-options-to-enum.patch
Patch69:    packaging/PATCH-70-83-super-ddf-Remove-update_super_ddf.patch
Patch70:    packaging/PATCH-71-83-super0-refactor-the-code-for-enum.patch
Patch71:    packaging/PATCH-72-83-super1-refactor-the-code-for-enum.patch
Patch72:    packaging/PATCH-73-83-super-intel-refactor-the-code-for-enum.patch
Patch73:    packaging/PATCH-74-83-Change-update-to-enum-in-update_super-and-upd.patch
Patch74:    packaging/PATCH-75-83-Manage-Incremental-code-refactor-string-to-en.patch
Patch75:    packaging/PATCH-76-83-Change-char-to-enum-in-context-update-refacto.patch
Patch76:    packaging/PATCH-77-83-mdmon-fix-segfault.patch
Patch77:    packaging/PATCH-78-83-util-remove-obsolete-code-from-get_md_name.patch
Patch78:    packaging/PATCH-79-83-mdadm-udev-Don-t-handle-change-event-on-raw-d.patch
Patch79:    packaging/PATCH-80-83-Manage-do-not-check-array-state-when-drive-is.patch
Patch80:    packaging/PATCH-81-83-incremental-manage-do-not-verify-if-remove-is.patch
Patch81:    packaging/PATCH-82-83-super-intel-make-freesize-not-required-for-ch.patch
Patch82:    packaging/PATCH-83-83-manage-move-comment-with-function-description.patch
Patch83:    packaging/PATCH-084-120-Revert-mdadm-systemd-remove-KillMode-none-f.patch
Patch84:    packaging/PATCH-085-120-Grow-fix-can-t-change-bitmap-type-from-none.patch
Patch85:    packaging/PATCH-086-120-Fix-NULL-dereference-in-super_by_fd.patch
Patch86:    packaging/PATCH-087-120-Mdmonitor-Make-alert_info-global.patch
Patch87:    packaging/PATCH-088-120-Mdmonitor-Pass-events-to-alert-using-enums-.patch
Patch88:    packaging/PATCH-089-120-Mdmonitor-Add-helper-functions.patch
Patch89:    packaging/PATCH-090-120-Add-helpers-to-determine-whether-directorie.patch
Patch90:    packaging/PATCH-091-120-Mdmonitor-Refactor-write_autorebuild_pid.patch
Patch91:    packaging/PATCH-092-120-Mdmonitor-Refactor-check_one_sharer-for-bet.patch
Patch92:    packaging/PATCH-093-120-util.c-reorder-code-lines-in-parse_layout_f.patch
Patch93:    packaging/PATCH-094-120-util.c-fix-memleak-in-parse_layout_faulty.patch
Patch94:    packaging/PATCH-095-120-Detail.c-fix-memleak-in-Detail.patch
Patch95:    packaging/PATCH-096-120-isuper-intel.c-fix-double-free-in-load_imsm.patch
Patch96:    packaging/PATCH-097-120-super-intel.c-fix-memleak-in-find_disk_atta.patch
Patch97:    packaging/PATCH-098-120-super-ddf.c-fix-memleak-in-get_vd_num_of_su.patch
Patch98:    packaging/PATCH-099-120-Create-goto-abort_locked-instead-of-return-.patch
Patch99:    packaging/PATCH-100-120-Create-remove-safe_mode_delay-local-variabl.patch
Patch100:   packaging/PATCH-101-120-Create-Factor-out-add_disks-helpers.patch
Patch101:   packaging/PATCH-102-120-mdadm-Introduce-pr_info.patch
Patch102:   packaging/PATCH-103-120-mdadm-Add-write-zeros-option-for-Create.patch
Patch103:   packaging/PATCH-104-120-tests-00raid5-zero-Introduce-test-to-exerci.patch
Patch104:   packaging/PATCH-105-120-manpage-Add-write-zeroes-option-to-manpage.patch
Patch105:   packaging/PATCH-106-120-Define-alignof-using-_Alignof-when-using-C1.patch
Patch106:   packaging/PATCH-107-120-Use-existence-of-etc-initrd-release-to-dete.patch
Patch107:   packaging/PATCH-108-120-mdmon-don-t-test-both-all-and-container_nam.patch
Patch108:   packaging/PATCH-109-120-mdmon-change-systemd-unit-file-to-use-foreg.patch
Patch109:   packaging/PATCH-110-120-mdmon-Remove-need-for-KillMode-none.patch
Patch110:   packaging/PATCH-111-120-mdmon-Improve-switchroot-interactions.patch
Patch111:   packaging/PATCH-112-120-mdopen-always-try-create_named_array.patch
Patch112:   packaging/PATCH-113-120-Improvements-for-IMSM_NO_PLATFORM-testing.patch
Patch113:   packaging/PATCH-114-120-Revert-Revert-mdadm-systemd-remove-KillMode.patch
Patch114:   packaging/PATCH-115-120-Create-Fix-checking-for-container-in-update.patch
Patch115:   packaging/PATCH-116-120-Fix-null-pointer-for-incremental-in-mdadm.patch
Patch116:   packaging/PATCH-117-120-super1-fix-truncation-check-for-journal-dev.patch
Patch117:   packaging/PATCH-118-120-Fix-some-cases-eyesore-formatting.patch
Patch118:   packaging/PATCH-119-120-Bump-minimum-kernel-version-to-2.6.32.patch
Patch119:   packaging/PATCH-120-120-Remove-the-config-files-in-mdcheck_start-co.patch
Patch120:   packaging/mdadm-udev.patch
Patch121:   packaging/mdadm-2.5.2-static.patch
Patch122:   packaging/disable-Werror.patch
